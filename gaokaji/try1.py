...
data_dir = 'D:/Pythonfile/flower_photos/flower_photos/'

output_path = 'D:/Pythonfile/flower_photos/list.txt'
...
_NUM_VALIDATION = 350
_RANDOM_SEED = 0
list_path = 'D:/Pythonfile/flower_photos/list.txt'
train_list_path = 'D:/Pythonfile/flower_photos/list_train.txt'
val_list_path = 'D:/Pythonfile/flower_photos/list_val.txt'
            ...
            for shard_id in range(_NUM_SHARDS):
                ...
                for i in range(start_ndx, end_ndx):
                    ...
                    example = dataset_utils.image_to_tfexample(
                        ...
                        image_data, b'jpg', 208, 208, int(lines[i][1]))
...
convert_dataset('D:/Pythonfile/flower_photos/list_train.txt', 'D:/Pythonfile/flower_photos/flower_photos', 'D:/Pythonfile/flower_photos/train/')
# os.system('mkdir -p val')
convert_dataset('D:/Pythonfile/flower_photos/list_val.txt', 'D:/Pythonfile/flower_photos/flower_photos', 'D:/Pythonfile/flower_photos/val/')

from PIL import Image
import os
import tensorflow as tf
filename='D:/Pythonfile/flower_photos/train/'
...
filename='D:/sharedhome/models/data/train/data_00000-of-00005.tfrecord'
